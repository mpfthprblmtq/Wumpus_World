 ...
 * Board
 */
public class Board16AI extends javax.swing.JFrame {

    //open file stream to agent
...
//                });
    ...
    private void initComponents() {
        ...
        prompt.setRows(5);
        prompt.setText("Load up a .jar file from your local machine, and make sure it's in the same directory as the the main project .jar!");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(scrollpane2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addComponent(upload, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(move, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(arrowIndicator, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void uploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_uploadActionPerformed
        ...
        switch(returnVal) {
            case 0:
                ...
                // update tile text file
                IO.outTile(game.getTileAt(game.getCurrX(), game.getCurrY()), game.getCurrX(), game.getCurrY(), SIZE);
                
                // try to make a move initially so that the make move button has something to read
                try {
                    makeMove();
                } catch (InterruptedException ex) {
        ...
        if (Desktop.isDesktopSupported()) {
            //while(!game.gameEnded) {
                try {
                    ...
                    try(Scanner fileInput = new Scanner(new File("nextMove.txt"))) {
                        ...
                        if (goBack)
                        {
                            IO.outTile(game.getCurrX(), game.getCurrY(), SIZE);
                        }
                    }
                    
                } catch (IOException ex) {
                    // nothing to catch.  MY CODE ALWAYS WORKS
                }
            //}
        }
...
//        climb.setEnabled(false);
    ...
    public void up() {
        ...
        // discover the tile
        game.board[game.getCurrY()][game.getCurrX()].setDiscovered(true);
    ...
    public void grab() {
        ...
        if (game.checkTileForGold()) {
            ...
            goldIndicator.setIcon(new ImageIcon("src//img//gold1.png"));
