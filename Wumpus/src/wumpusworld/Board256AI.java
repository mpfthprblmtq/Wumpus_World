 ...
 * Class Board 256
 */
public class Board256AI extends javax.swing.JFrame {
...
//                });
    ...
    private void initComponents() {
        ...
        goldIndicator.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/gold_empty.png"))); // NOI18N

        arrowIndicator.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        arrowIndicator.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/bow_arrow.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(tileScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 923, Short.MAX_VALUE)
                .addContainerGap())
        );
...
//        climb.setEnabled(false);
    ...
    public void fireUp() {
        ...
        if (game.checkTileForWumpus(game.getCurrX(), game.getCurrY() - 1)) {
            ...
            if (game.getNumArrows() == 0) {
                //arrow.setEnabled(false);
                arrowIndicator.setIcon(new ImageIcon("src//img//bow_noarrow.png"));
            }
            //grab.setEnabled(true);
            prompt.setText("");
    ...
    public void grab() {
        ...
        if (game.checkTileForGold()) {
            ...
            goldIndicator.setIcon(new ImageIcon("src//img//gold_full.png"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Board256AI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Board256AI().setVisible(true);
        });
    }
